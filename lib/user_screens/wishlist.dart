...
class WishListState extends State<WishList> {
  ...
  Future<void> openBox() async {
    try {
      coursesBox = await Hive.openBox<Courses>('wishlisted_courses_box');
    } catch (e) {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if(courses!.isWishListed == true) {
                  return Padding(
            padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 16.0),
            child: GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => Enroll(course: courses)));
              },
              child: Container(
