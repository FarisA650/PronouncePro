              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Row(
                    ...
                    children: [Text("Forgot Password?", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold))],
                  ),
                ),
                  ...
                  onTap: () async {
                    if (_formkey.currentState?.validate() ?? false) {
                      ...
                      if (emailController.text == "admin@gmail.com" &&
                        ...
                        prefs.setString(SplashScreenState.KEY_LOGIN, 'adminLoggedIn');
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    const Text("New member?", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold)),
